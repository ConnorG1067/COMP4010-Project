...
# Every-visit
def monte_carlo(is_training, env, discount_factor, epsilon, epsilon_decay_rate, episodes, model_path="", fig_path=""):
    q = helpers.fetch_model(is_training, env, model_path)
...
def run(episodes, learning_rate_a, discount_factor, epsilon, epsilon_decay_rate, max_model_step, is_training=True, render=False, model_path="", fig_path=""):
    ...
    if("q_learning" in model_path):
        ...
        monte_carlo(is_training, env, discount_factor, epsilon, epsilon_decay_rate, episodes, model_path, fig_path)
...
if __name__ == "__main__":
    ...
    if(testing):
        ...
        # algorithms = ["actor_critic", "monti_carlo"]
        algorithms = ["dyna_q"]
        ...
        running_model_path = "./models/sarsa/sarsa_iter_15000_lr_0.1_df_0.9_e_0.9_edr_0.0001_ms_1.pkl"
